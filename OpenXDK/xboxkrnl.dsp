...
# ADD CPP /nologo /G6 /MT /Za /W3 /O2 /X /I "include" /I "include\xlibc" /D "_XBOX" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /FD /QIfist /c
# SUBTRACT CPP /YX
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /entry:"XboxKrnlEntryDummy" /subsystem:windows /machine:I386 /nodefaultlib /subsystem:native
